using System;
 ...
 namespace EmulatorLauncher
 {
  ...
  string gameId = null;  //  ADDED
 

  //  NEW: Parse for -gameid
  for (int i = 0; i < args.Length; i++) {  //  Changed loop start to 0
  ...
  try
  {
  path = generator.Generate(SystemConfig["system"], SystemConfig["emulator"], SystemConfig["core"], SystemConfig["rom"], gameId, screenResolution);  //  Modified Generate call
  }
  catch (Exception ex)
  {
  generator.Cleanup();
